...
import {Clocking} from "@app/services/sqlite/entities/clocking";
...
export class HomePage implements ViewWillEnter, ViewWillLeave {
    ...
    public async ionViewWillEnter(): Promise<any> {
        ...
        this.sqliteService.get<Clocking>(TableName.clocking).subscribe((clockingArray: Array<Clocking>) => {
            console.log(clockingArray);
        });
    }
